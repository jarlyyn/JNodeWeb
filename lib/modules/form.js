...
var onCreateRuntime=function(data)
{
  ...
  runtime.forms={};
  runtime.validateForms=validateForms;
}
var validateForms=function(forms,callback)
{
  this.web.Form.JForm.validateBody(this.req,forms,callback);
}
var Form=function(web)
{
    ...
    this.JForm.setForms=function(req,models){
      var runtime=FormModule.web.install(req);
      _.assign(runtime.forms,models);
    };
...
Form.prototype.registerValidator=function(name,func)
{
  return this.JForm.registerValidator(name,func);
}
...
Form.prototype.doValidate=function(forms)
{
  ...
  {
    var fromsNeedValidate=[];
    for(var index in forms)
    {
      if (runtime.forms[forms[index]]==null){
	fromsNeedValidate.push(forms[index]);
      }
    }
    FormModule.JForm.validateBody(runtime.req,fromsNeedValidate,runtime.next);
  };
}
