...
JForm.prototype.getData=function(req,callback)
{
  this.getBody(req,function(err,body){
    ...
    {
      this.getParams(req,function(err,params)
      {
        callback(err,{body:body,query:query,params:params});
      })
    })
  });
}
...
FormModel.prototype.getKeyword=function()
{
  return (this.keyword!=null)?
    this.keyword
  :(this.method=='get'||this.method=='params'?null:this.name);
}
