...
{
  var form=this.forms[name]=new FormModel(name,method);
  return form;
}
...
JForm.prototype.validateBody=function(req,forms,callback)
{
  ...
  this.getData(req,function(err,data){
    JForm.validate(forms,data,function(err,models)
    {
...
var FormModel=function(name,method)
{
  this.name=name;
  this.method=method;
  this.fields={};
