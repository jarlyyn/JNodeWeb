...
{
  var form=this.forms[name]=new FormModel(name);
  return form;
}
...
JForm.prototype.validateBody=function(req,forms,callback)
{
  ...
  this.getBody(req,function(err,body){
    JForm.validate(forms,body,function(err,models)
    {
